...
// Gtting File Data
    ...
    $sql = "Update cars SET title='$title', price='$price',modelName='$modelName',brand='$brand',color='$color',productType='$productType',picture='$picture' WHERE id='$id'";
 

if($result = mysqli_query($con,$sql))
{  
  echo json_encode(['data'=>'Successfully updated data to the table','fileuploadSuccess'=>$target_path]);
}
else
{
